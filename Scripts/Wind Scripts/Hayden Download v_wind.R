# HAYDEN BARRA - This script downloads every day of data for specific locations
...
# build urls
url1 <-  "https://dapds00.nci.org.au/thredds/dodsC/ob53/output/reanalysis/AUS-11/BOM/ERA5/historical/hres/BARRA-R2/v1/day/vas/latest/vas_AUS-11_ERA5_historical_hres_BOM_BARRA-R2_v1_day_"
url2 <-  ".nc"
i=year_month$year_month[1]
url <-  "https://dapds00.nci.org.au/thredds/dodsC/ob53/output/reanalysis/AUS-11/BOM/ERA5/historical/hres/BARRA-R2/v1/day/uas/latest/vas_AUS-11_ERA5_historical_hres_BOM_BARRA-R2_v1_day_199303-199303.nc"
full_url <- paste0(url1,i,"-",i,url2) 
url
full_url

# build locations - could be a csv
...
for(i in 1:nrow(year_month)){
  ...
  write_csv(et2, paste0("Data/Wind Data/v_wind_", year_month$year_month[i],".csv"))
